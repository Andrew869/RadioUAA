...
<div class="links-consejo">
    ...
    <div class="consejo-integrantes">
        <div class="integrante c1">
            <img src="resources/img/Foto1.png" alt="Imagen Presidente" class="integrante-img">
            <div>
                <h2>Lic. Mario Gerardo de Ávila - Presidente</h2>
                <p>Egresado de la Licenciatura en Medio Masivo de Comunicación (1985-1990) por la Universidad Autónoma de Aguascalientes, donde inició su trayectoria en 1987 como colaborador de la Radio Universitaria.</p>
                <p>Entre 1990 y 2010, trabajó como camarógrafo, operador de audio, guionista y productor en el Departamento de Videoproducción de la Dirección General de Difusión. Además, impulsó áreas de producción audiovisual en el INEGI.</p>
                <p>Fue director de producción en el canal independiente CV+TV Canal 20 (2008-2010) y formó parte del equipo fundador del Canal de Televisión de la Universidad Autónoma de Aguascalientes, donde fue jefe de Televisión en dos periodos (2010-2012 y 2018-2020).</p>
                <p>Tras 35 años de servicio, se retiró en 2020. Ha colaborado en libros, periódicos y revistas.</p>
            </div>
        </div>
        ...
        <div class="integrante c1">
            ...
            <div>
                ...
                <p>Licenciada en Comunicación e Información por la Benemérita Universidad Autónoma de Aguascalientes, con 15 años de experiencia en medios locales e internacionales. Actualmente, es reportera de información general en el periódico *El Sol del Centro*.</p>
                <p>Comenzó su carrera a los 17 años en estaciones de Radio Universal y Radio Grupo, destacando en programas como *Lavando Ajeno* y en producciones de RyTA como *Destino Aguascalientes*, *Lotería Musical* y *Escuadrón Musical*, con alcance internacional en Mexicanal.</p>
                <p>Es actriz y entre los diversos grupos en que ha participado resalta Callejuelas Teatro donde lleva 11 años de participación interpretando 13 de los 15 papeles femeninos a desempeñar en el concepto del grupo. En el ámbito periodístico, colaboró en *Periódico Picacho* y *El Heraldo de Aguascalientes*. Estudió una especialidad en Cine y Comunicación Audiovisual en la Universidad de Viña del Mar y trabajó como locutora en UCV radio en Chile.</p>
                <p>Es coach de voz, creadora de los cursos *Soy Mi Voz* y *El Poder de mi Voz*, y capacitadora de candidatas de certámenes de belleza y figuras políticas. Además, dirige *Agencia RA Entertainment*, su propia marca de skincare *Ámate*, y la boutique *DiSueñArte*.</p>
           </div>
        </div>
    </div>

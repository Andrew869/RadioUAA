...
<div class="page-content">
    <div class="texto-frecuentes">
        ...
        <h2><div class="icon"><?php echo GetSVG($jsInitPath."resources/img/svg/gallo-min.svg", ["30px", "30px", "black"]) ?></div>¿Qué es Radio UAA?</h2>
        ...
        <h2><div class="icon"><?php echo GetSVG($jsInitPath."resources/img/svg/gallo-min.svg", ["30px", "30px", "black"]) ?></div>¿Qué contenidos se transmiten en Radio UAA?</h2>
        ...
        <h2><div class="icon"><?php echo GetSVG($jsInitPath."resources/img/svg/gallo-min.svg", ["30px", "30px", "black"]) ?></div>¿Quién integra Radio UAA?</h2>
        ...
        <h2><div class="icon"><?php echo GetSVG($jsInitPath."resources/img/svg/gallo-min.svg", ["30px", "30px", "black"]) ?></div>En mi navegador no se visualizan los contenidos correctamente.</h2>
        ...
        <h2><div class="icon"><?php echo GetSVG($jsInitPath."resources/img/svg/gallo-min.svg", ["30px", "30px", "black"]) ?></div>¿En qué medios puedo escuchar Radio UAA?</h2>
        ...
        <h2><div class="icon"><?php echo GetSVG($jsInitPath."resources/img/svg/gallo-min.svg", ["30px", "30px", "black"]) ?></div>Soy miembro de la comunidad universitaria y tengo una idea de un programa.</h2>
        ...
        <h2><div class="icon"><?php echo GetSVG($jsInitPath."resources/img/svg/gallo-min.svg", ["30px", "30px", "black"]) ?></div>Soy externo a la comunidad universitaria y tengo una idea de un programa.</h2>
        <p>Si te gustaría colaborar con Radio UAA entra en contacto con nosotros, estamos buscando gente interesada en participar con nosotros.</p>

        <h2><div class="icon"><?php echo GetSVG($jsInitPath."resources/img/svg/gallo-min.svg", ["30px", "30px", "black"]) ?></div>¿Dónde encuentro el Aviso de Privacidad?</h2>
        <p>Consúltalo en Políticas de Privacidad y Términos de Servicio.</p>

        <h2><div class="icon"><?php echo GetSVG($jsInitPath."resources/img/svg/gallo-min.svg", ["30px", "30px", "black"]) ?></div>¿Dónde encuentro los términos de servicio?</h2>
        <p>Consúltalo en Políticas de Privacidad y Términos de Servicio.</p>

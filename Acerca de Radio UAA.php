...
<body>
    <nav class="navbar">
        <div class="logo">
            <a href="Inicio.html">
                <img src="imgs/logo-radio-uaa-blanco.png" alt="Radio UAA Logo" />
            </a>        
        </div>
...
<script src="js/search.js"></script> <!-- Asegúrate de que la ruta sea correcta -->
